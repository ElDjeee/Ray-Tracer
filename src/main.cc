...
void bouncing_spheres() {
    ...
    world.add(make_shared<sphere>(point3(0.0, -1000.0, 0), 1000.0, make_shared<lambertian>(checker)));
    ...
    auto material2 = make_shared<lambertian>(color(0.4, 0.4, 0.2));
...
void perlin_sphere() {
    ...
    world.add(make_shared<sphere>(point3(0.0, -1000.0, 0.0), 1000.0, make_shared<lambertian>(pertext)));
    world.add(make_shared<sphere>(point3(0.0,     2.0, 0.0),    2.0, make_shared<lambertian>(pertext)));
